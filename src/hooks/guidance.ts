...
const LOCAL_CODER = [
  ...
  "",
  "**Which model is your choice, not a tier's (Decision 56).** There is no default:",
  "`golem llamacpp models` ranks a curated GGUF ladder against this machine's free",
  "RAM and `golem llamacpp setup --model <id>` installs one and points `coder` at it,",
  "which is how a 35B MoE runs on 8 GB of VRAM. With nothing configured, `coder`",
  "still resolves from the Ollama tier catalog exactly as before.",
  "",
