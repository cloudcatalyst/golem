 ...
 *
 * Frozen tool names (IMPLEMENTATION_PLAN §2.5): golem_search, golem_get_chunk,
 * golem_index_path, golem_expand, golem_stats, golem_set_slider, golem_delegate,
 ...
 *
 * B1 ships the P0 tools (golem_expand, golem_stats, golem_set_slider) and all
