...
- **Next in R8b: [R8.6](tasks/R8.6.md)** — the LSP bridge, which by the same
  measurement discipline must be a **mode of the `code` tool**, not four new tools.
...
_Generated by `golem task index` from `docs/plan/tasks/` — 14 ready, 9 blocked, 1 done. Edit the task documents, not this table._
